import { View, Text, StatusBar, TouchableOpacity, Image, SafeAreaView, Linking, Alert } from 'react-native'
      ...
      <View className="rounded-t-3xl -mt-12 bg-white relative">
        ...
        <View
          ...
          <View style={{ backgroundColor: 'rgba(255,255,255,0.4)' }} className="p-1 rounded-full">
            <Image style={{ backgroundColor: 'rgba(255,255,255,0.4)' }} className="w-16 h-16 rounded-full" source={require('../assets/images/deliveryGuy.jpg')} />
          </View>

          <View className="flex-1 ml-3">
            <Text className="text-lg font-bold text-white">Suneel Sahu</Text>
            <Text className="text-white font-semibold">Your Rider</Text>
          </View>
          <View className="flex-row items-center space-x-3 mr-3">
            <TouchableOpacity onPress={() => Linking.openURL(`tel:${'9542384676'}`)} className="bg-white p-2 rounded-full">
